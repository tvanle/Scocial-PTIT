...
-- CreateEnum
CREATE TYPE "MemberStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'BANNED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'COMMENT', 'FOLLOW', 'GROUP_INVITE', 'GROUP_REQUEST', 'GROUP_APPROVED', 'MENTION', 'SYSTEM');
