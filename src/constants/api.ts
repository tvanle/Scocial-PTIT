...
export const ENDPOINTS = {
  ...
  AUTH: {
    ...
    VERIFY_EMAIL_PUBLIC: '/auth/verify-email-public',
  ...
  POST: {
    ...
    COMMENT_REPLIES: (commentId: string) => `/posts/comments/${commentId}/replies`,
    LIKE_COMMENT: (commentId: string) => `/posts/comments/${commentId}/like`,
    SHARE_COMMENT: (commentId: string) => `/posts/comments/${commentId}/share`,
    USER_COMMENT_SHARES: (userId: string) => `/posts/user/${userId}/comment-shares`,
    SHARE: (id: string) => `/posts/${id}/share`,
    UNSHARE: (id: string) => `/posts/${id}/share`,
    ...
    USER_SHARES: (userId: string) => `/posts/user/${userId}/shares`,
    USER_REPLIES: (userId: string) => `/posts/user/${userId}/replies`,
    FEED: '/posts/feed',
