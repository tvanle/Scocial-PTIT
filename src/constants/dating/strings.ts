...
export const DATING_STRINGS = {
  ...
  prompts: {
    sectionTitle: 'Câu hỏi giới thiệu',
    sectionHint: 'Chọn câu hỏi và viết câu trả lời để người khác hiểu thêm về bạn',
    selectQuestion: 'Chọn câu hỏi',
    answerPlaceholder: 'Viết câu trả lời của bạn...',
    questions: [
      'Điều bất ngờ về tôi là...',
      'Bài hát tôi có thể nghe mãi...',
      'Bữa ăn lý tưởng của tôi là...',
      'Nếu có một ngày tự do, tôi sẽ...',
      'Mục tiêu lớn nhất năm nay của tôi là...',
      'Tôi đang tìm kiếm...',
      'Thú cưng yêu thích của tôi...',
      'Sở thích bí mật của tôi là...',
      'Tôi tự hào về...',
      'Cuốn sách thay đổi cuộc đời tôi...',
    ] as string[],
  },
  profileDetail: {
    major: 'NGÀNH HỌC',
  ...
  discovery: {
    ...
    matchHeaderTitle: 'Kết nối thành công',
    matchSubtitle: (name: string) =>
      `Bạn và ${name} đã thích nhau. Bắt đầu một cuộc trò chuyện để xem mọi thứ sẽ đi đến đâu!`,
    matchSendMessage: 'Gửi tin nhắn',
    matchContinueDiscovery: 'Tiếp tục khám phá',
    matchCloseA11y: 'Đóng màn hình kết nối',
    matchSendMessageA11y: 'Gửi tin nhắn cho người vừa kết nối',
    matchContinueDiscoveryA11y: 'Tiếp tục khám phá hồ sơ khác',
    unknownName: 'Không rõ',
    swipeNopeLabel: 'PASS',
