...
export const DATING_COLORS_SEMANTIC = {
  ...
  navInactive: '#9ca3af',
  // Profile Detail
  detailHeaderBtnBg: 'rgba(0,0,0,0.25)',
  detailHeaderIcon: '#ffffff',
  detailLocationIcon: '#e83030',
  detailLocationText: '#6b7280',
  detailInfoCardBg: '#ffffff',
  detailInfoCardBorder: '#f3f4f6',
  detailInfoCardLabel: '#9ca3af',
  detailInfoCardValue: '#111827',
  detailInfoCardIcon: 'rgba(236, 19, 19, 0.1)',
  detailInfoCardIconColor: '#e83030',
  detailSectionTitle: '#111827',
  detailSectionIcon: '#e83030',
  detailBioText: '#4b5563',
  detailChipBg: 'rgba(236, 19, 19, 0.08)',
  detailChipText: '#e83030',
  detailChipBorder: 'rgba(236, 19, 19, 0.15)',
  detailCampusBg: 'rgba(236, 19, 19, 0.06)',
  detailCampusBorder: 'rgba(236, 19, 19, 0.12)',
  detailCampusIcon: '#e83030',
  detailCampusTitle: '#e83030',
  detailCampusBody: '#6b7280',
  detailDivider: '#f3f4f6',
  detailActionBarBg: '#ffffff',
  detailVerified: '#e83030',
