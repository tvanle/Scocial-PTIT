...
export const AnimatedLogo: React.FC<AnimatedLogoProps> = ({ animatedStyle, surfaceColor, glowColor }) => {
    return (
...
const styles = StyleSheet.create({
    ...
    iconSurface: {
        ...
        ...Platform.select({
            ios: {
                shadowColor: '#FA4E57', // Distinct red shadow combined with the physical glow node
